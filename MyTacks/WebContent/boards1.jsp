...
<body>
<%out.println((String)request.getAttribute("boardName")); %>
<div class="container">
			<header class="clearfix">
				<span>Blueprint <span class="bp-icon bp-icon-about" data-content="BOARDS"></span></span>
</header>

<input type="button" id="boardName" value="${boardName}"/>
